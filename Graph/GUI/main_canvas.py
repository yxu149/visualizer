...
class MainCanvas(Frame): 
    def __init__(self, root, width=200, height=200): 
        ...
        self.__i0 = Label(root, justify='left', text=str_i0, width=w1, height=h3)
        self.__i1 = Label(root, justify='left', text=str_i1, width=w1, height=h3)
        self.__i2 = Label(root, justify='left', text=str_i2, width=w1, height=h3)
        self.__i3 = Label(root, justify='left', text=str_i3, width=w1, height=h3)
        
        self.__g0 = canvas.Panel(root, events=l0.get_events(), icons=l0.get_icons(), width=w1, height=h2)
        self.__g1 = canvas.Panel(root, events=l0.get_events(), icons=l0.get_icons(), width=w1, height=h2)
        self.__g2 = canvas.Panel(root, events=l0.get_events(), icons=l0.get_icons(), width=w1, height=h2)

        self.__l0 = panel6.Panel(root, events=l0.get_events(), icons=l0.get_icons(), width=w1, height=h2)
        self.__s0 = panel8.Panel(root, events=s0.get_events(), icons=s0.get_icons(), width=w1, height=h1)
        self.__s1 = panel8.Panel(root, events=s1.get_events(), icons=s1.get_icons(), width=w1, height=h1)
        self.__s2 = panel8.Panel(root, events=s2.get_events(), icons=s2.get_icons(), width=w1, height=h1)
        self.__s3 = panel8.Panel(root, events=s3.get_events(), icons=s3.get_icons(), width=w1, height=h1)

        self.__col0 = columns.Col(root, width=w0, height=h0, top=self.__i0, mid=self.__g0, down=self.__s0)
        self.__col1 = columns.Col(root, width=w0, height=h0, top=self.__i1, mid=self.__g1, down=self.__s1) 
        self.__col2 = columns.Col(root, width=w0, height=h0, top=self.__i2, mid=self.__g2, down=self.__s2)
        self.__col3 = columns.Col(root, width=w0, height=h0, top=self.__i3, mid=self.__l0, down=self.__s3)
        ...
        # Column 3
        self.__i3.grid(row=0, column=0, padx=(0, TEXT_PADX), pady=(0, TEXT_PADY), stick = "NSEW")
        self.__l0.grid(row=1, column=0, padx=(0, CANVAS_PADX), pady=(0, CANVAS_PADY), stick = "NSEW")
        self.__s3.grid(row=2, column=0, padx=(0, BUTTON_S_PADX), pady=(0, BUTTON_S_PADY), stick = "NSEW")
