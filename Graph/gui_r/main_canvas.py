...
class MainCanvas(tk.Frame): 
    def __init__(self, root, width=200, height=200): 
        ...
        self.__s1 = panel8.Panel(self, root, events=s1.get_events(), icons=s1.get_icons(), width=w1, height=h1)
        self.__s2 = panel8.Panel(self, root, events=s2.get_events(), icons=s2.get_icons(), width=w1, height=h1)
        self.__s3 = panel8.Panel(self, root, events=s3.get_events(), icons=s3.get_icons(), width=w1, height=h1)

        self.__col0 = columns.Col(self, root, width=w0, height=h0, top=self.__i0, mid=self.__g0, down=self.__s0)
