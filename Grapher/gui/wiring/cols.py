...
class Col1(tk.Frame): 
    def __init__(self, root, w=settings.w1, h=settings.h0): 
        ...
        self.__mid = panel6.Panel(self, events=media_ctrl.get_events(), icons=media_ctrl.get_icons())
        self.__down = panel8.Panel(self, events=io_ctrl.get_events(), icons=io_ctrl.get_icons())
        self.__pack_on_screen()
...
class Col2(tk.Frame): 
    def __init__(self, root, w=settings.w1, h=settings.h0): 
        ...
        self.__mid = panel6.Panel(self, events=media_ctrl.get_events(), icons=media_ctrl.get_icons())
        self.__down = panel8.Panel(self, events=extra_ctrls_1.get_events(), icons=extra_ctrls_1.get_icons())
        self.__pack_on_screen()
...
class Col3(tk.Frame): 
    def __init__(self, root, w=settings.w1, h=settings.h0): 
        ...
        self.__mid = panel6.Panel(self, events=media_ctrl.get_events(), icons=media_ctrl.get_icons())
        self.__down = panel8.Panel(self, events=extra_ctrls_2.get_events(), icons=extra_ctrls_2.get_icons())
        self.__pack_on_screen()
